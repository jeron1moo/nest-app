                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' : 'data-target="#xs-controllers-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' :
                                            'id="xs-controllers-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' : 'data-target="#xs-injectables-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' :
                                        'id="xs-injectables-links-module-AppModule-28395741c65fc5041b0951c0cfedae12"' }>
                                        <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/PostModule.html" data-type="entity-link" >PostModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' : 'data-target="#xs-controllers-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' :
                                            'id="xs-controllers-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' : 'data-target="#xs-injectables-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' :
                                        'id="xs-injectables-links-module-PostModule-c7def137299160f9cdd873f63f6fab98"' }>
                                        <li class="link">
